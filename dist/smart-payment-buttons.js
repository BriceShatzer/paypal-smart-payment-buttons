window.spb = function(modules) {
    ...
    "./node_modules/post-robot/dist/post-robot.js": function(module, exports, __webpack_require__) {
    ...
    "./node_modules/post-robot/index.js": function(module, exports, __webpack_require__) {
        module.exports = __webpack_require__("./node_modules/post-robot/dist/post-robot.js");
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__("./node_modules/post-robot/index.js");
        ...
        function canUseVenmoDesktopPay(funding) {
        ...
        function getNativePopupUrl(_ref8) {
            ...
            "venmo" === fundingSource && delete queryParams.sdkMeta;
        ...
        var PAYMENT_FLOWS = [ {
            ...
            isEligible: function(_ref4) {
                ...
                var isValidVenmoDesktopPaySituation = canUseVenmoDesktopPay(props.fundingSource || props.enableFunding[0]);
                return !(!("mobile" === platform || isIOSSafari() || isAndroidChrome() || isValidVenmoDesktopPaySituation) || onShippingChange && !isNativeOptedIn({
                    props: props
                }) && !isValidVenmoDesktopPaySituation || createBillingAgreement || createSubscription || !supportsPopups() || !firebaseConfig || !isNativeOptedIn({
                    props: props
                }) && (!(isValidVenmoDesktopPaySituation || "local" !== env && "stage" !== env) || merchantID.length > 1 || -1 !== LSAT_UPGRADE_EXCLUDED_MERCHANTS.indexOf(clientID)));
            },
            ...
            init: function(_ref2) {
                ...
                var isVenmoDesktopPay = canUseVenmoDesktopPay(fundingSource);
                    ...
                    click: function() {
                        return promise_ZalgoPromise.try((function() {
                            ...
                            return isVenmoDesktopPay ? function(_ref8) {
                                ...
                                QRCodeComponentInstance.renderTo(QRCodeRenderTarget, "body");
                                function updateQRCodeComponentState(newState) {
                                    QRCodeComponentInstance.updateProps(_extends({
                                        cspNonce: config.cspNonce,
                                        qrPath: url,
                                        onClose: closeQRCode
                                    }, newState));
                                }
                                var onApproveQR = function(res) {
                                ...
                                var onCancelQR = function() {
                                    closeQRCode("onCancel");
                                    return onCancelCallback();
                                };
                                var onErrorQR = function(res) {
                                    updateQRCodeComponentState({
                                        state: "qr_authorized",
                                ...
                                return new promise_ZalgoPromise((function() {
                                ...
                                return new promise_ZalgoPromise((function(resolve, reject) {
                                    var nativePopup = function(_ref2) {
                                        ...
                                        var nativePopupWin = window.open(getNativePopupUrl({
                                            props: props,
                                            serviceData: serviceData,
                                            fundingSource: fundingSource
                                        }));
